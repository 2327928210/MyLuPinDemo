package com.haoke.mylupindemo.lib.funsdk.support.utils;
...
public class Define {
	...
	public static final boolean IsSupportTalk(int devType) {
		...
		case DeviceWifiManager.DEVICE_TYPE.BOB:
		case DeviceWifiManager.DEVICE_TYPE.CAR:
		case DeviceWifiManager.DEVICE_TYPE.FEYE:
		case DeviceWifiManager.DEVICE_TYPE.ROBOT:
		case DeviceWifiManager.DEVICE_TYPE.SEYE:
		case DeviceWifiManager.DEVICE_TYPE.MONITOR:
			return true;
		default:
			return false;
		}
	...
	public static final boolean IsSupportSmallStream(int devType) {
		...
		case DeviceWifiManager.DEVICE_TYPE.MOV:
			return true;
		default:
			return false;
		}
	...
	public static final int getDevSettingType(int devType) {
		int type;
		switch (devType) {
		case DeviceWifiManager.DEVICE_TYPE.SOCKET:
		case DeviceWifiManager.DEVICE_TYPE.BULB:
		case DeviceWifiManager.DEVICE_TYPE.BULB_SOCKET:
			type = devType;
			break;
		default:
			type = DeviceWifiManager.DEVICE_TYPE.MONITOR;
		}
		return type;
	}
	...
	public static final boolean IsSupportFeyeSet(int devType) {
		switch (devType) {
		case DeviceWifiManager.DEVICE_TYPE.FEYE:
		case DeviceWifiManager.DEVICE_TYPE.FBULB:
			return true;
		default:
			return false;
		}
	...
	public static final boolean IsSupportRemoteCtrl(int devType,
		...
		case DeviceWifiManager.DEVICE_TYPE.BULB:
		case DeviceWifiManager.DEVICE_TYPE.FBULB:
		case DeviceWifiManager.DEVICE_TYPE.MUSIC_BOX:
		case DeviceWifiManager.DEVICE_TYPE.SPEAKER:
		case DeviceWifiManager.DEVICE_TYPE.NSEYE:
		case DeviceWifiManager.DEVICE_TYPE.ROBOT:
			return false;
		default:
			return true;
