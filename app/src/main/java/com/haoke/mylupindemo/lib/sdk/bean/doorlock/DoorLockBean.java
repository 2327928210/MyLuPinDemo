package com.haoke.mylupindemo.lib.sdk.bean.doorlock;


import com.haoke.mylupindemo.lib.funsdk.support.config.EventHandler;
...
public class DoorLockBean {
    ...
    public com.haoke.mylupindemo.lib.funsdk.support.config.EventHandler EventHandler;
