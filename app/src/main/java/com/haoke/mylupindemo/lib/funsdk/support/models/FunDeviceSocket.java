package com.haoke.mylupindemo.lib.funsdk.support.models;


import com.haoke.mylupindemo.lib.funsdk.support.config.BaseConfig;
import com.haoke.mylupindemo.lib.funsdk.support.config.OPPowerSocketGet;
import com.haoke.mylupindemo.lib.funsdk.support.config.PowerSocketArm;
import com.haoke.mylupindemo.lib.funsdk.support.config.PowerSocketAutoLight;
import com.haoke.mylupindemo.lib.funsdk.support.config.PowerSocketAutoSwitch;
import com.haoke.mylupindemo.lib.funsdk.support.config.PowerSocketAutoUsb;
import com.haoke.mylupindemo.lib.funsdk.support.config.PowerSocketBanLed;
import com.haoke.mylupindemo.lib.funsdk.support.config.PowerSocketDelayLight;
import com.haoke.mylupindemo.lib.funsdk.support.config.PowerSocketDelaySwitch;
import com.haoke.mylupindemo.lib.funsdk.support.config.PowerSocketDelayUsbPower;
import com.haoke.mylupindemo.lib.funsdk.support.config.PowerSocketImage;
import com.haoke.mylupindemo.lib.funsdk.support.config.PowerSocketSensitive;
import com.haoke.mylupindemo.lib.funsdk.support.config.PowerSocketWorkRecord;
